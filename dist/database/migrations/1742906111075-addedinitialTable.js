...
class AddedinitialTable1742906111075 {
    ...
    up(queryRunner) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield queryRunner.query(`ALTER TABLE "organizatons" ADD CONSTRAINT "FK_483a4f7dec9f7546ef27ae6516f" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
            ...
            yield queryRunner.query(`ALTER TABLE "userdetails" ADD CONSTRAINT "FK_f0b221b2021ef01fcf2fe2cee22" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    down(queryRunner) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield queryRunner.query(`ALTER TABLE "userdetails" DROP CONSTRAINT "FK_f0b221b2021ef01fcf2fe2cee22"`);
            ...
            yield queryRunner.query(`ALTER TABLE "organizatons" DROP CONSTRAINT "FK_483a4f7dec9f7546ef27ae6516f"`);
...
exports.AddedinitialTable1742906111075 = AddedinitialTable1742906111075;
